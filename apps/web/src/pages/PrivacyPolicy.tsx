...
const PrivacyPolicy = () => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const res = await apiClient.get("/v1/content/privacy-policy");
        if (res.data?.success) {
            ...
            {loading ? (
              ...
              <div>
                ...
                <p className="text-muted-foreground text-lg leading-relaxed">
                  Your privacy is critical to us. VoteSphere does not sell your data, and handles all voter information securely.
                </p>
              </div>
            )}
          </CardContent>
